...
def main():
	...
	# ARMOR_HEAD.set_rEquipement(adventurer, adventurer, BASIC_SET, 1, {'from': user.address})

	# BASIC_SET.transferFrom(
	# 	ARMOR_HEAD.RARITY_EXTENDED_NCP(),
	# 	adventurer,
	# 	ARMOR_HEAD.RARITY_EXTENDED_NCP(),
	# 	1,
	# 	0,
	...
	# tx = ARMOR_HEAD.set_rEquipement(DEVELOPER[1], DEVELOPER[1], BASIC_SET, 1, {'from': DEVELOPER[0]})
	# print(tx.call_trace())
