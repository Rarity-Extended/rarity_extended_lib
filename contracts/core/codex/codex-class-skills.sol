...
contract codex_core_class_skills {
    string constant public index = "Class Skills";
    string constant public class = "Any";

    codex_core_skills constant _codex_skills = codex_core_skills(0x67ae39a2Ee91D7258a86CD901B17527e19E493B3);
